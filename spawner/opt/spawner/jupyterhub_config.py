...
if os.environ.get('JUPYTERHUB_COOKIE_SECRET'):
    ...
    c.JupyterHub.cookie_secret_file = '/var/run/spawner/data/cookie_secret'

c.JupyterHub.db_url = '/var/run/spawner/data/database.sqlite'
...
cluster_role_binding_resource = api_client.resources.get(
...
config_root = '/opt/spawner/configs'
...
environ_config_file = '/var/run/spawner/configs/jupyterhub_config.py'
